...
\label{cha:2}
In this chapter the simultaneous approach is examined more closely and implemented into python. Instead of using \texttt{fmincon} which is a very general black box method, a more specific algorithm should both run faster and converge more often. For this problem the Augmented Lagrangian Method has been chosen.
